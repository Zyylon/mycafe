...
import { ref, onValue, update, get, remove, set, child } from 'firebase/database';
            ...
            <View style={[styles.userItem, item.disabled && styles.disabledUserItem]}>
                    ...
                    <View style={styles.userInfoContainer}>
                        ...
                        <View style={styles.userInfo}>
                            ...
                            <View style={styles.roleBadge}>
                                <Text style={[
                                    styles.userRole, 
                                    { color: item.role === 'superadmin' ? '#f43f5e' : item.role === 'admin' ? '#fbbf24' : '#94a3b8' }
                                ]}>
                ...
                {canModify && (
                    <View style={styles.actionRow}>
                        ...
                        {/* Superadmin: Edit Profile Button */}
                ...
                {/* Expanded Details: Login History */}
                                ...
                                <View key={index} style={styles.historyRow}>
                                    <View style={{flex: 1}}>
                                        <View style={{flexDirection: 'row', alignItems: 'center', marginBottom: 2}}>
                                            <Ionicons 
                                                name={log.platform === 'web' ? 'globe-outline' : 'phone-portrait-outline'} 
                                                size={14} color="#64748b" style={{marginRight: 6}} 
                                            />
